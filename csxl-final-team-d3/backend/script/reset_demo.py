...
from ..test.services.announcement import announcement_data
from ..test.services.announcement import announcement_demo_data
...
with Session(engine) as session:
    ...
    announcement_data.insert_fake_data(session)
    announcement_demo_data.insert_fake_data(session)
