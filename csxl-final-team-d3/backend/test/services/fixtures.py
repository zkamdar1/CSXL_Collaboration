...
def announcement_svc_integration(session: Session):
    """This fixture is used to test the AnnnouncementsService class with a real PermissionService."""
    return AnnouncementsService(session, PermissionService(session))
